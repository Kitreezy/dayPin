...
/// Renders any NoteCard to a UIImage suitable for external sharing.
/// - ImageCard  → base photo with annotation pins composited on top
/// - TextCard   → styled dark card (title + body text)
/// - LinkCard   → styled dark card (title + URL + description)
enum CardRenderer {
